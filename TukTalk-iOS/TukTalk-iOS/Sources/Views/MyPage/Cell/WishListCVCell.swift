...
class WishListCVCell: UICollectionViewCell {
    ...
    var heartImg = UIImageView().then {
        $0.image = UIImage(named: "heartFillImg")
    }
    ...
    func setData(mentor: WishListResponseElement) {
...
extension WishListCVCell: UICollectionViewDelegateFlowLayout {
